                ...
                <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                    ...
                    <div className="flex gap-3 w-full md:w-auto overflow-x-auto pb-2 md:pb-0 items-center">
                        ...
                        <input 
                            ...
                            className="border border-gray-300 rounded-lg px-4 py-2 w-full md:w-64 hover:shadow-md hover:border-blue-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-sm transition-all duration-300" 
                        />
